...
class ConsultaListagemParcelaRecorrenciaIntegrationTest extends AbstractIntegrationTest {

    private static final String URL_RECORRENCIAS_PARCELAS = "/v1/recorrencias/parcelas";
    ...
    private static final String JSON_PATH_PARCELAS_RECORRENCIAS_INDEX = "$.parcelas[%s].identificadorParcela";
    ...
    private static final String IDENTIFICADOR_PARCELA_1 = "2DDF2A2BCF9FE8B2E063C50A17ACB3A4";
    private static final String IDENTIFICADOR_PARCELA_2 = "2DDF2A2BCF9FE8B2E063C50A17ACB3A6";
    private static final String IDENTIFICADOR_PARCELA_3 = "2DDF2A2BCF9FE8B2E063C50A17ACB3A5";
    private static final String IDENTIFICADOR_PARCELA_4 = "2DDF2A2BCF9FE8B2E063C50A17ACB3A7";

    @Test
    void dadoFiltroAgenciaContaExistentes_quandoConsultarParcelas_deveRetornarPaginaComAsParcelasDasRecorrencias () throws Exception {
        ...
        mockMvc.perform(mockHttpServletRequestBuilder)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath(JSON_PATH_PAGINACAO_NUMERO_ELEMENTOS).value(6))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath(String.format(JSON_PATH_PARCELAS_RECORRENCIAS_INDEX, 0)).value(IDENTIFICADOR_PARCELA_1))
                .andExpect(MockMvcResultMatchers.jsonPath(String.format(JSON_PATH_PARCELAS_RECORRENCIAS_INDEX, 1)).value(IDENTIFICADOR_PARCELA_2))
                .andExpect(MockMvcResultMatchers.jsonPath(String.format(JSON_PATH_PARCELAS_RECORRENCIAS_INDEX, 3)).value(IDENTIFICADOR_PARCELA_3))
                .andExpect(MockMvcResultMatchers.jsonPath(String.format(JSON_PATH_PARCELAS_RECORRENCIAS_INDEX, 2)).value(IDENTIFICADOR_PARCELA_4))
                .andDo(print());
    }

    @Test
    void dadoTodosFiltrosPreenchidos_quandoConsultarParcelas_deveRetornarPaginaComAsParcelasDasRecorrencias () throws Exception {
        ...
        var mockHttpServletRequestBuilder = executarGet()
                ...
                .queryParam(QUERY_PARAM_DATA_INICIAL, String.valueOf(LocalDate.now()))
                .queryParam(QUERY_PARAM_DATA_FINAL, String.valueOf(LocalDate.now().plusMonths(5)));
    ...
    @Test
    void dadoTodosTipoRecorrenciaAgendadoOuAgendadoRecorrente_quandoConsultarParcelas_deveRetornarPaginaComAsParcelasDasRecorrencias () throws Exception {
    ...
    class ValidacaoConstraints {
        ...
        void dadoFiltroAgenciaPagadorInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String agenciaPagador) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
        ...
        void dadoFiltroCpfCnpjPagadorInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String cpfCnpjPagador) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
        ...
        @ParameterizedTest
        @ValueSource(strings = {"REMOVIDO"})
        void dadoFiltroStatusInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String status) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
            ...
            mockMvc.perform(mockHttpServletRequestBuilder)
                    .andExpect(MockMvcResultMatchers.status().isBadRequest())
                    .andExpect(MockMvcResultMatchers.jsonPath(JSON_PATH_DETAILS_MESSAGE).value("Lista de status da parcela da recorrencia inválida"));
        }

        @ParameterizedTest
        @ValueSource(strings = {"1 2", "ASV123", "12.23", "123456789012345678901"})
        void dadoFiltroContaPagadorInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String contaPagador) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
        ...
        void dadoFiltroTipoRecorrenciaInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String tipoRecorrencia) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
        ...
        void dadoFiltroTipoPessoaPagadorInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String tipoPessoaPagador) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
        ...
        void dadoFiltroTamanhoPaginaInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String tamanhoPagina) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
        ...
        @Test
        void dadoFiltroNumeroPaginaNulo_quandoConsultarParcelas_deveRetornarBadRequest() throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_TAMANHO_PAGINA, TAMANHO_PAGINA_DEZ)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
                    .queryParam(QUERY_PARAM_CONTA_PAGADOR, CONTA);
        ...
        @Test
        void dadoFiltroTamanhoPaginaNulo_quandoConsultarParcelas_deveRetornarBadRequest() throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
                    .queryParam(QUERY_PARAM_NUMERO_PAGINA, NUMERO_PAGINA_ZERO)
                    .queryParam(QUERY_PARAM_AGENCIA_PAGADOR, COOPERATIVA)
                    .queryParam(QUERY_PARAM_CONTA_PAGADOR, CONTA);
        ...
        void dadoFiltroNumeroPaginaInvalido_quandoConsultarParcelas_deveRetornarBadRequest(String numeroPagina) throws Exception {
            var mockHttpServletRequestBuilder = executarGet()
    ...
    private static MockHttpServletRequestBuilder executarGet() {
        return MockMvcRequestBuilders.get(URL_RECORRENCIAS_PARCELAS)
